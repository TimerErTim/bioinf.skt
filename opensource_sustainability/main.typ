...
#set text(lang: "de")
#show: opensource-presentation.with(
  title: [Open Source Software ist nicht wichtig!\ #underline[Oder?]],
  author: [Tim Peko],
...
#slide(footer: "Override the default footer if necessary.", title: "Mixing it Up")[
...
#slide(title: "Literature and Figure", footer: "")[#bibliography("refs.yaml", title: none, style: "trends")]
